...
# Bot information
SESSION = environ.get('SESSION', 'TechVkBot')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '2292550345'))
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filtertest87:HQW98PvoPQZjfR7g@cluster0.r81ck.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "clonefilterbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'newcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/t7fufufuff')
